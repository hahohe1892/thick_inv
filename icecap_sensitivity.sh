...
fig, ax = plt.subplots()
points1 = ax.scatter(xs,vols_tf/true_vol, c = bed_deviations_tf, label='true friction field prescribed', cmap='plasma', marker = 'v', vmin = 0, vmax = np.max(bed_deviations))
...
plt.savefig('./figures/ice_temperature_errors_v1.png')
plt.show()
